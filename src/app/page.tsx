...
export default function Home() {
  ...
  return (
    <div className="md:w-[90rem]  bg-gray-100">
      {/* Menu Navegação */}
      <Header/>
      
      {/* CTA */}
      <div className="flex flex-col h-72 lg:h-[50rem]">
        <Image 
            src={backCta1}
            className="object-cover object-bottom h-72 lg:h-[50rem]"
      ...
      <div className="flex flex-col py-4 lg:p-8 justify-center">
        ...
        <div className="flex flex-col gap-4 lg:gap-8 items-center">
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:gap-16">
            <div className="max-w-72 border-2 border-slate-500/75 flex flex-col gap-4 p-8 rounded-xl ">
                ...
                <p className="text-xl lg:text-2xl font-bold">Experiência</p>
            ...
            <div className="max-w-72 border-2 border-slate-500/75 flex flex-col gap-4 p-8 rounded-xl ">
                ...
                <p className="text-xl lg:text-2xl font-bold">Sustentabilidade</p>
                <p>Utilizamos energia limpa e sustentável.</p>
            </div>                
            <div className="max-w-72 border-2 border-slate-500/75 flex flex-col gap-4 p-8 rounded-xl ">
                <Image className="h-12 w-12" src={iconCompromisso} alt="Icone Caminhão" />
                <p className="text-xl lg:text-2xl font-bold">Compromisso</p>
        ...
        {/* Nossa História */}
        <div className="flex flex-col-reverse lg:flex-row-reverse py-4 lg:p-8 max-h-min justify-center items-center">
            {/* Tratos */}
            <Image 
              src={backSobreHome}
              className="object-cover object-left lg:rounded-2xl md:w-3/5"
              alt="Vista sob o telhado com placas de enegia solar e colina de Sal"
            />
            {/* Texto */}
            <div className="relative flex flex-col gap-8 bg-secundary p-4 lg:-mr-12 lg:p-12 md:w-2/5 text-slate-200 lg:rounded-2xl">
              <span className="place-self-center font-bold text-2xl lg:text-4xl">Nossa História...</span>
              <p className="font-medium lg:text-xl">Há mais de 50 anos atuando no mercado brasileiro, reconhecida 
                nacionalmente pela qualidade dos produtos e atendimento customizado. 
              </p>
              <p className="font-medium lg:text-xl">Estamos melhorando continuamente nossos sistemas e processos 
      ...
      <div className="flex flex-col justify-center items-center p-8 pb-16 gap-8 max-h-min bg-slate-300/60">
        <div className="text-2xl lg:text-4xl font-semibold text-primary p-4">Produtos</div>
        <div className="flex flex-col items-center gap-8 lg:flex-row lg:gap-32">
          <div className="flex flex-col w-72 justify-center items-center lg:size-96 bg-slate-100 rounded-xl">
            <Image className="w-60 md:w-72" src={linhaIndustriaImage} alt="Imagem do Produto Sal Moído de 25 kg" />
            <div className="border-2 border-collapse border-slate-400/60 w-48 my-2 md:w-1/3"/>
            <div className="font-semibold p-2 text-2xl text-primary">Linha Indústria</div>
          </div>
          <div className="flex flex-col w-72 justify-center items-center lg:size-96 bg-slate-100 rounded-xl">
            <Image className="w-60 md:w-72" src={linhaAnimalImage} alt="Imagem do Produto Sal Moído de 25 kg" />
            <div className="border-2 border-collapse border-slate-400/60 w-48 my-2 md:w-1/3"/>
            <div className="font-semibold p-2 text-2xl text-primary">Linha Indústria</div>
          </div>
        </div>
      ...
      <div className="flex flex-col-reverse lg:flex-row p-8 justify-center items-center">
        ...
        <div className="flex flex-col justify-center items-center md:w-1/2 p-2">
          <Image className="w-80 h-auto" src={seloEnergiaLimpa} alt="Selo empresa energia limpa" />
